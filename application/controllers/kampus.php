...
class kampus extends CI_Controller{
	...
	function tambah_aksi() {
		$this->form_validation->set_rules('nim','Nim','requiered|min_legth[8]max_legth[8]');
		$this->form_validation->set_rules('nama','Nama','requiered|min_legth[5]max_legth[15]');
		$this->form_validation->set_rules('alamat','Alamat','requiered|alpha');
		$this->form_validation->set_rules('pekerjaan','Pekerjaan','requiered|alpha');
